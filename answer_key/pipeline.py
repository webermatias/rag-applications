...
def create_dataset(corpus: list[dict],
    ...
    text_splitter = SentenceSplitter(chunk_size=chunk_size, chunk_overlap=chunk_overlap, tokenizer=encoder.encode)
...
def create_parent_chunks(episode_list: list[list], 
                         window_size: int=2,
